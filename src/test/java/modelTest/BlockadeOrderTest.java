...
public class BlockadeOrderTest {
	...
	public void init() {
		...
		l_VCVObject.checkCommand(l_gameEngine, "blockade "+d_country.getName(), this.d_player);
	}
	...
	public void testExecute() {
		...
		assertEquals("Neutral", d_country.getOwner().getName());
	}
}
