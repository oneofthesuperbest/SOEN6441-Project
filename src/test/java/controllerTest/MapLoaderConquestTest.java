...
public class MapLoaderConquestTest {
	...
	@Before public void init() {
		...
		l_VCVObject.checkCommand(d_gameEngineObject, "editmap src/test/test_resources/testmap_3Countries_Conquest.map", null);
	}
	...
	@Test public void testDefaultPhase() {
		...
		l_VCVObject.checkCommand(d_gameEngineObject, "savemap src/test/test_resources/testmap_3Countries_DominationTest.map 1", null);
