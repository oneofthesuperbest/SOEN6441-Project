...
public class MapControllerTest {
     ...
     */
    @Before public void loadMapBeforeTest(){
        // load a valid map.
        l_mapController
                .loadMapData("src/test/test_resources/testmap.map", false, false);
    }

    /**
     * Clear the map after every test case.
     */
    @After public void clearMapAfterTest(){
        l_gameEngineObj.getMapState().clear();
    }

    /**
     * Test if the map is a fully connected graph.
     * - The entire graph must be fully connected.
     */
    @Test public void mapValFullyConnectedTest(){
        // isolate a country.
    ...
    /**
     * Test if Continent is fully connected.
     * - The continent must be a fully connected sub graph.
     */
    @Test public void mapValFullyConnectedContinentTest(){
     ...
     */
    @Test public void addContinentTest(){
        // add a new continent.
     ...
     */
    @Test public void addCountryTest(){
        // add a new country.
    ...
    /**
     * Test if continent is empty.
     * - A continent cannot be empty.
     */
    @Test public void mapValEmptyContinentTest(){
