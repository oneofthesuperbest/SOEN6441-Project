...
public class ExecuteOrderPhase extends IntermediateOrderPhase {
	...
	public int delop(Order p_order) {
		this.d_gameEngineObject.getLogEntryBuffer().addLogEntry("Delop order was executed.");
	...
	public int advance(Order p_order) {
		this.d_gameEngineObject.getLogEntryBuffer().addLogEntry("Advance order was executed.");
	...
	public int bomb(Order p_order) {
		this.d_gameEngineObject.getLogEntryBuffer().addLogEntry("Bomb order was executed.");
	...
	public int blockade(Order p_order) {
		this.d_gameEngineObject.getLogEntryBuffer().addLogEntry("Blockade order was executed.");
	...
	public int negotiate(Order p_order) {
		this.d_gameEngineObject.getLogEntryBuffer().addLogEntry("Negotiate order was executed.");
	...
	public int airlift(Order p_order) {
		this.d_gameEngineObject.getLogEntryBuffer().addLogEntry("Airlift order was executed.");
