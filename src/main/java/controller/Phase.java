...
/**
 * This class is used to used an abstract state class, which is used to
 * maintain/handle current phase state
 */
public abstract class Phase {
	...
	/**
	 * This method is used to get the current phase in string format. For e.g.: In
	 * GamePlay StartUp Phase, it returns "Gameplay Start up"
	 * 
	...
	/**
	 * This function is used to invoke another function that edits continent as per
	 * the command
	 * 
	...
	/**
	 * This function is used to invoke another function that edits continents as per
	 * the command
	 * 
	 * @param p_command The command entered by the user
	 */
	...
	/**
	 * This function is used to invoke another function that edits neighbors as per
	 * the command
	 * 
	 * @param p_command The command entered by the user
	 */
	...
	/**
	 * This function is used to invoke another function that adds/removes players as
	 * per the command
	 * 
	 * @param p_command The command entered by the user
	 */
